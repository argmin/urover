...
class RoverState():
    def __init__(self):
        ...
        self.o_angles = None # Angles of navigable terrain pixels
        self.o_dists = None # Distances of navigable terrain pixels
        self.r_angles = None # Angles of navigable terrain pixels
        self.r_dists = None # Distances of navigable terrain pixels
...
def telemetry(sid, data):
    ...
    if data:
        ...
        if np.isfinite(Rover.vel):
            ...
            Rover = decision_step(Rover, args.type)
